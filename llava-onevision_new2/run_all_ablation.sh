...
#SBATCH --output=LLaVA-OneVision-1.5-8B-Instruct_ablation.out
#SBATCH -N 1
#SBATCH --gres=gpu:1
#SBATCH --mem=246000M
...
python run_all_ablation.py \
    --model_path "/data/LLM_Model/LLaVA-OneVision-1.5-8B-Instruct" \
    ...
    --output_dir "/workspace/lizhou/LLMPenetration/multi-agent_hatespeech/multi-agent_enhance_Multi3Hate_new/llava-onevision_new2/ablation" \
